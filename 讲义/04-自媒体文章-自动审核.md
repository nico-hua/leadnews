...
![image-20210504211635199](04-自媒体文章-自动审核.assets\image-20210504211635199.png)
...
2. 打开[云盾内容安全产品试用页面](https://promotion.aliyun.com/ntms/act/lvwangdemo.html)，单击**立即开通**，正式开通服务。
   ...
   ![image-20210504213452171](04-自媒体文章-自动审核.assets\image-20210504213452171.png)

   内容安全控制台

   ![image-20210504213510896](04-自媒体文章-自动审核.assets\image-20210504213510896.png)

   

3. 在[AccessKey管理页面](https://ak-console.aliyun.com/#/accesskey)管理您的AccessKeyID和AccessKeySecret。

   ![image-20210504213530641](04-自媒体文章-自动审核.assets\image-20210504213530641.png)

   管理自己的AccessKey,可以新建和删除AccessKey

   ![image-20210504213547219](04-自媒体文章-自动审核.assets\image-20210504213547219.png)

   查看自己的AccessKey，

   AccessKey默认是隐藏的，第一次申请的时候可以保存AccessKey，点击显示，通过验证手机号后也可以查看

   ![image-20210504213605004](04-自媒体文章-自动审核.assets\image-20210504213605004.png)

#### 2.3)文本内容审核接口

文本垃圾内容检测：https://help.aliyun.com/document_detail/70439.html?spm=a2c4g.11186623.6.659.35ac3db3l0wV5k 

![image-20210504213640667](04-自媒体文章-自动审核.assets\image-20210504213640667.png)
...
![image-20210504213719323](04-自媒体文章-自动审核.assets\image-20210504213719323.png)
...
![image-20210504213812303](04-自媒体文章-自动审核.assets\image-20210504213812303.png)

添加到自动配置中

![image-20210504214013276](04-自媒体文章-自动审核.assets\image-20210504214013276.png)
...
![image-20210505005300287](04-自媒体文章-自动审核.assets\image-20210505005300287.png)

ap_article_config  文章配置表

![image-20210505005353286](04-自媒体文章-自动审核.assets\image-20210505005353286.png)

ap_article_content 文章内容表

![image-20210505005407987](04-自媒体文章-自动审核.assets\image-20210505005407987.png)

#### 3.2)分布式id

随着业务的增长，文章表可能要占用很大的物理存储空间，为了解决该问题，后期使用数据库分片技术。将一个数据库进行拆分，通过数据库中间件连接。如果数据库中该表选用ID自增策略，则可能产生重复的ID，此时应该使用分布式ID生成策略来生成ID。

![image-20210505005448995](04-自媒体文章-自动审核.assets\image-20210505005448995.png)

snowflake是Twitter开源的分布式ID生成算法，结果是一个long型的ID。其核心思想是：使用41bit作为毫秒数，10bit作为机器的ID（5个bit是数据中心，5个bit的机器ID），12bit作为毫秒内的流水号（意味着每个节点在每毫秒可以产生 4096 个 ID），最后还有一个符号位，永远是0

![image-20210505005509258](04-自媒体文章-自动审核.assets\image-20210505005509258.png)
...
![image-20210505005733405](04-自媒体文章-自动审核.assets\image-20210505005733405.png)
...
![image-20210505010728156](04-自媒体文章-自动审核.assets\image-20210505010728156.png)

status字段：0 草稿  1 待审核  2 审核失败  3 人工审核  4 人工审核通过  8 审核通过（待发布） 9 已发布

#### 4.2)实现

![image-20210505010755954](04-自媒体文章-自动审核.assets\image-20210505010755954.png)
...
![image-20210505010938575](04-自媒体文章-自动审核.assets\image-20210505010938575.png)
...
![image-20210507160209926](04-自媒体文章-自动审核.assets\image-20210507160209926.png)

#### 4.5)服务降级处理

![image-20210507160329016](04-自媒体文章-自动审核.assets\image-20210507160329016.png)
...
![image-20210507160912993](04-自媒体文章-自动审核.assets\image-20210507160912993.png)
...
![image-20210524160517744](04-自媒体文章-自动审核.assets\image-20210524160517744.png)

检索的过程

![image-20210524160549596](04-自媒体文章-自动审核.assets\image-20210524160549596.png)
...
![image-20210524160611338](04-自媒体文章-自动审核.assets\image-20210524160611338.png)
...
![image-20210524161243572](04-自媒体文章-自动审核.assets\image-20210524161243572.png)
...
![image-20210524161406081](04-自媒体文章-自动审核.assets\image-20210524161406081.png)
...
![image-20210709110852966](04-自媒体文章-自动审核.assets\image-20210709110852966.png)
...
![image-20210709111445360](04-自媒体文章-自动审核.assets\image-20210709111445360.png)
