...
![image-20210513145942962](05-延迟任务精准发布文章.assets\image-20210513145942962.png)
...
![image-20210513150058814](05-延迟任务精准发布文章.assets\image-20210513150058814.png)
...
![image-20210513150319742](05-延迟任务精准发布文章.assets\image-20210513150319742.png)

##### 2.2.3)redis实现

zset数据类型的去重有序（分数排序）特点进行延迟。例如：时间戳作为score进行排序

![image-20210513150352211](05-延迟任务精准发布文章.assets\image-20210513150352211.png)

### 3)redis实现延迟任务

实现思路

![image-20210513150440342](05-延迟任务精准发布文章.assets\image-20210513150440342.png)
...
![image-20210513151649297](05-延迟任务精准发布文章.assets\image-20210513151649297.png)
...
![image-20210513151812858](05-延迟任务精准发布文章.assets\image-20210513151812858.png)
...
![image-20210513151835752](05-延迟任务精准发布文章.assets\image-20210513151835752.png)
...
![image-20210513152138388](05-延迟任务精准发布文章.assets\image-20210513152138388.png)
...
![image-20210514181214681](05-延迟任务精准发布文章.assets\image-20210514181214681.png)
...
![image-20210515162329679](05-延迟任务精准发布文章.assets\image-20210515162329679.png)

方案2：scan 

SCAN 命令是一个基于游标的迭代器，SCAN命令每次被调用之后， 都会向用户返回一个新的游标， 用户在下次迭代时需要使用这个新游标作为SCAN命令的游标参数， 以此来延续之前的迭代过程。

![image-20210515162419548](05-延迟任务精准发布文章.assets\image-20210515162419548.png)
...
![image-20210515162537224](05-延迟任务精准发布文章.assets\image-20210515162537224.png)

Pipeline请求模型

![image-20210515162604410](05-延迟任务精准发布文章.assets\image-20210515162604410.png)

官方测试结果数据对比

![image-20210515162621928](05-延迟任务精准发布文章.assets\image-20210515162621928.png)
...
![image-20210516112243712](05-延迟任务精准发布文章.assets\image-20210516112243712.png)
...
![image-20210516112457413](05-延迟任务精准发布文章.assets\image-20210516112457413.png)
...
![image-20210516112612399](05-延迟任务精准发布文章.assets\image-20210516112612399.png)
...
![image-20210721013255332](05-延迟任务精准发布文章.assets\image-20210721013255332.png)
